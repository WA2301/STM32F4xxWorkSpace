...
/**
  ******************************************************************************
  * @macro   Periph BitBand [Not same as M3]
  * @Example Set     GPIO: (*GPO_BB(GPIOE_BASE,15) =1)
	*          Reset   GPIO: (*GPO_BB(GPIOE_BASE,15) =0)
	*          Reverse GPIO: (*GPO_BB(GPIOE_BASE,15)^=1)
	*          Read    GPIO:= *GPI_BB(GPIOE_BASE,15)
  ******************************************************************************
  */ 
#define GPO_BB(GP,N)  (vu32*)(PERIPH_BB_BASE + (GP-PERIPH_BASE+0x14) * 32 + (N * 4)) 
#define GPI_BB(GP,N)  (vu32*)(PERIPH_BB_BASE + (GP-PERIPH_BASE+0x10) * 32 + (N * 4)) 
